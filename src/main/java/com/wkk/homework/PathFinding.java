...
public class PathFinding {
    ...
    JSlider size = new JSlider(1,50,2);
    ...
    JLabel lengthL = new JLabel("路径: "+length);
        ...
        creditB.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(frame, "	                         最短路径\n"
                        + "                  Author     KongWiki\n"
                        + "          Start:  May 3, 2020   ", "版本", JOptionPane.PLAIN_MESSAGE, new ImageIcon(""));
            }
        });
